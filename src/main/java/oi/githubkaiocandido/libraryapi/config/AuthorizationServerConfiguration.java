...
public class AuthorizationServerConfiguration {
    ...
    public SecurityFilterChain authSecurityFilterChain(HttpSecurity http) throws  Exception{
        ...
        http.oauth2ResourceServer(oauthTwoRs -> oauthTwoRs.jwt(Customizer.withDefaults()));
    ...
    private RSAKey gerarChaveRsa() throws Exception{
        ...
        RSAPrivateKey cahvePrivada = (RSAPrivateKey) keyPair.getPrivate();

        return new RSAKey
                .Builder(chavePublica)
                .privateKey(cahvePrivada)
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                ...
                .tokenIntrospectionEndpoint("/oauth2/token/introspect")
                //revogar token
